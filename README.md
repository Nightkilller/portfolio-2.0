...
## Features
- Interactive Profile Avatar with hover winking animation (`avatar-normal.svg` & `avatar-wink.svg`).
- Split-screen layout with white left sidebar and dark green self-healing cutting grid mat workspace.
